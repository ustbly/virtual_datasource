...
public final class SourceControlServiceGrpc {
  ...
  public static final String SERVICE_NAME = "SourceControlService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceSetInfo> getListAllSourcesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListAllSources",
      requestType = com.google.protobuf.Empty.class,
      responseType = proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceSetInfo.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceSetInfo> getListAllSourcesMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceSetInfo> getListAllSourcesMethod;
      ...
      synchronized (SourceControlServiceGrpc.class) {
        if ((getListAllSourcesMethod = SourceControlServiceGrpc.getListAllSourcesMethod) == null) {
          SourceControlServiceGrpc.getListAllSourcesMethod = getListAllSourcesMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceSetInfo>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceSetInfo.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommand,
      proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommandReply> getSendSourceCommandMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendSourceCommand",
      requestType = proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommand.class,
      responseType = proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommandReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommand,
      proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommandReply> getSendSourceCommandMethod() {
    io.grpc.MethodDescriptor<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommand, proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommandReply> getSendSourceCommandMethod;
      ...
      synchronized (SourceControlServiceGrpc.class) {
        if ((getSendSourceCommandMethod = SourceControlServiceGrpc.getSendSourceCommandMethod) == null) {
          SourceControlServiceGrpc.getSendSourceCommandMethod = getSendSourceCommandMethod =
              io.grpc.MethodDescriptor.<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommand, proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommandReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendSourceCommand"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommand.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommandReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SubscribeRequest,
      com.google.protobuf.Any> getSubscribeSourceMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SubscribeSourceMessage",
      requestType = proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SubscribeRequest.class,
      responseType = com.google.protobuf.Any.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SubscribeRequest,
      com.google.protobuf.Any> getSubscribeSourceMessageMethod() {
    io.grpc.MethodDescriptor<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SubscribeRequest, com.google.protobuf.Any> getSubscribeSourceMessageMethod;
      ...
      synchronized (SourceControlServiceGrpc.class) {
        if ((getSubscribeSourceMessageMethod = SourceControlServiceGrpc.getSubscribeSourceMessageMethod) == null) {
          SourceControlServiceGrpc.getSubscribeSourceMessageMethod = getSubscribeSourceMessageMethod =
              io.grpc.MethodDescriptor.<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SubscribeRequest, com.google.protobuf.Any>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SubscribeSourceMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SubscribeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static abstract class SourceControlServiceImplBase implements io.grpc.BindableService {
    ...
    public void listAllSources(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceSetInfo> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListAllSourcesMethod(), responseObserver);
    }

    /**
     */
    public void sendSourceCommand(proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommand request,
        io.grpc.stub.StreamObserver<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommandReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSendSourceCommandMethod(), responseObserver);
    }

    /**
     */
    public void subscribeSourceMessage(proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SubscribeRequest request,
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ...
                proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceSetInfo>(
                  this, METHODID_LIST_ALL_SOURCES)))
          .addMethod(
            getSendSourceCommandMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommand,
                proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommandReply>(
                  this, METHODID_SEND_SOURCE_COMMAND)))
          .addMethod(
            getSubscribeSourceMessageMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SubscribeRequest,
  ...
  public static final class SourceControlServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SourceControlServiceBlockingStub> {
    ...
    /**
     */
    public proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceSetInfo listAllSources(com.google.protobuf.Empty request) {
    ...
    /**
     */
    public proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommandReply sendSourceCommand(proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommand request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    public java.util.Iterator<com.google.protobuf.Any> subscribeSourceMessage(
        proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SubscribeRequest request) {
  ...
  public static final class SourceControlServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SourceControlServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceSetInfo> listAllSources(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommandReply> sendSourceCommand(
        proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommand request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_SEND_SOURCE_COMMAND:
          serviceImpl.sendSourceCommand((proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommand) request,
              (io.grpc.stub.StreamObserver<proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SourceCommandReply>) responseObserver);
          break;
        case METHODID_SUBSCRIBE_SOURCE_MESSAGE:
          serviceImpl.subscribeSourceMessage((proto_compile.cetc41.nodecontrol.SourceControlServiceApi.SubscribeRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Any>) responseObserver);
          break;
        default:
  ...
  private static abstract class SourceControlServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return proto_compile.cetc41.nodecontrol.SourceControlServiceApi.getDescriptor();
    }
