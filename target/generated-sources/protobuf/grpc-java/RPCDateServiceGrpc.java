...
@javax.annotation.Generated(
    ...
    comments = "Source: rpcDate.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class RPCDateServiceGrpc {

  private RPCDateServiceGrpc() {}

  public static final String SERVICE_NAME = "RPCDateService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<RPCDateServiceApi.RPCDateRequest,
      RPCDateServiceApi.RPCDateResponse> getGetDateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getDate",
      requestType = RPCDateServiceApi.RPCDateRequest.class,
      responseType = RPCDateServiceApi.RPCDateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<RPCDateServiceApi.RPCDateRequest,
      RPCDateServiceApi.RPCDateResponse> getGetDateMethod() {
    io.grpc.MethodDescriptor<RPCDateServiceApi.RPCDateRequest, RPCDateServiceApi.RPCDateResponse> getGetDateMethod;
      ...
      synchronized (RPCDateServiceGrpc.class) {
        if ((getGetDateMethod = RPCDateServiceGrpc.getGetDateMethod) == null) {
          RPCDateServiceGrpc.getGetDateMethod = getGetDateMethod =
              io.grpc.MethodDescriptor.<RPCDateServiceApi.RPCDateRequest, RPCDateServiceApi.RPCDateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getDate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RPCDateServiceApi.RPCDateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RPCDateServiceApi.RPCDateResponse.getDefaultInstance()))
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                RPCDateServiceApi.RPCDateRequest,
                RPCDateServiceApi.RPCDateResponse>(
  ...
  public static final class RPCDateServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<RPCDateServiceBlockingStub> {
    ...
    /**
     */
    public RPCDateServiceApi.RPCDateResponse getDate(RPCDateServiceApi.RPCDateRequest request) {
  ...
  public static final class RPCDateServiceFutureStub extends io.grpc.stub.AbstractFutureStub<RPCDateServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<RPCDateServiceApi.RPCDateResponse> getDate(
        RPCDateServiceApi.RPCDateRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DATE:
          serviceImpl.getDate((RPCDateServiceApi.RPCDateRequest) request,
              (io.grpc.stub.StreamObserver<RPCDateServiceApi.RPCDateResponse>) responseObserver);
          break;
        default:
